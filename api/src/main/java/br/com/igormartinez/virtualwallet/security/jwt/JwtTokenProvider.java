package br.com.igormartinez.virtualwallet.security.jwt;
...
public class JwtTokenProvider {
    ...
    public Token createAccessToken(String username, String role) {
        ...
        String accessToken = getAccessToken(username, role, now, validity);
    ...
    public Token refreshToken(String refreshToken) {
        ...
        role = decodedJWT.getClaim("role").as(String.class);
     ...
     * @throws IllegalArgumentException
     */
    private String getAccessToken(String username, String role, ZonedDateTime now, ZonedDateTime validity) {
     ...
     * @throws IllegalArgumentException
     */
    private String getRefreshToken(String username, String role, ZonedDateTime now) {
